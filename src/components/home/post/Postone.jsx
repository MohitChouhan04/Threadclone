  ...
  return (
    <Stack flexDirection={'column'} alignItems={'center'} justifyContent={'space-between'} >
        ...
        <Stack flexDirection={'column'} alignItems={'center'} gap={2} height={'100%'}>
            ...
            <Stepper orientation={'vertical'} activeStep={0} sx={{border:'0.1rem solid gray',
                width:'0px',
                height:'100%',
            }}></Stepper>
            {
                e ? e.comments.length > 0 ?
                <AvatarGroup total={e?.comments.length} sx={{
                '& . MuiAvatar-root':{
                    width:_700?24:16,
                    height:_700?24:16,
                    fontSize:_700?12:8
                ...
                <Avatar src={e?.comments[0].admin.profilePic} alt={e?.comments[0].admin.userName}/>
                {
                    e.comments.length > 1 ? (
                        <Avatar src={e?.comments[1].admin.profilePic} alt={e?.comments[1].admin.userName}/>
                    ) :null
                }
            </AvatarGroup> : '' : ''
            } 
