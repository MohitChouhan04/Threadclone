...
export const { addPostModel ,editProfileModel , toggleMainMenu , toggleMyMenu , toggleColorMode , addMyInfo ,addUser , addSingle,addToAllPost , deleteThePost , addToSearchedUsers , addPostId} = serviceSlice.actions;
